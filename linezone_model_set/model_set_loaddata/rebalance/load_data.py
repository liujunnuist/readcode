...
if __name__ == '__main__':
    ...
    pi, oi, di, i0, s, mv, itp, mpa, mss = db_layer.load_data(dt.date(2019,3,29))

    pi.to_pickle('pi.pickle')
    oi.to_pickle('oi.pickle')
    di.to_pickle('di.pickle')
    i0.to_pickle('i0.pickle')
    s.to_pickle('s.pickle')
    mv.to_pickle('mv.pickle')
    itp.to_pickle('itp.pickle')
    mpa.to_pickle('mpa.pickle')
    mss.to_pickle('mss.pickle')
