...
class DataLayer(object):
    ...
    def load_org_basic_info(self):
        ...
        sql = '''
                              ...
                              WHERE (stockorg_code = '0001') OR (status = '正常' AND org_flag = 1)

                            '''
        # erke_shidian_edw_ai_dev  code  status
        data_type = {'dt': [],
                     'int': ['is_store'],
                     'float': [],
    ...
    def load_sales_data(self, date_dec):
        ...
        # erke_shidian_edw_ai_dev.dim_stockorg status
    ...
    def load_data_from_local(self):
        pi = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\pi.pickle')
        oi = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\oi.pickle')
        di = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\di.pickle')
        i0 = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\i0.pickle')
        s = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\s.pickle')
        mv = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\mv.pickle')
        itp = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\itp.pickle')
        mpa = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\mpa.pickle')
        mss = pd.read_pickle('C:\\Users\\liuju\\Desktop\\linezone_model_set\\data0329\\mss.pickle')
        return pi, oi, di, i0, s, mv, itp, mpa, mss
    ...
    def load_data(self, date_dec):
        ...
        # lz_logger.info('Reading data from local')
        # pi, oi, di, i0, s, mv, itp, mpa, mss = \
...
#     db_layer = DataLayer()
#     pi, oi, di, i0, s, mv, itp, mpa, mss = db_layer.load_data('2019-03-17')
#     pi, oi, di, i0, s, mv, itp, mpa, mss.to_pickle()